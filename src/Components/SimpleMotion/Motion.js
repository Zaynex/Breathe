...
export default class SimpleMotion extends Component {
  static propTypes = {
  ...
  // changed from 0 to 400 to spring(0) again, that async currentStyle is still
  // at 0 (didn't have time to tick and interpolate even once). If we natively
  ...
  startAnimationIfNecessary = () => {
    ...
    this.animationID = defaultRaf((timestamp) => {
      ...
      if(shouldStopAnimation(
        ...
        // no need to cancel animationID here; should'nt have any in flight
      ...
      // more than 10 frames ? prolly switched broswer tab. Restart
